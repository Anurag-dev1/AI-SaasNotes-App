...
router.post('/', authenticate, apiRateLimit, csrfProtection, validate(createNoteSchema), notesController.create);
router.get('/:id', authenticate, apiRateLimit, validate(noteParamsSchema, 'params'), notesController.getById);
router.put('/:id', authenticate, apiRateLimit, csrfProtection, validate(noteParamsSchema, 'params'), validate(updateNoteSchema), notesController.update);
